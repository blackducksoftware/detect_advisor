    ...
    'BAZEL':
        {
            ...
            'execs': ['bazel'],
            'accuracy': 'HIGH',
            'cli_options': "--detect.bazel.cquery.options='OPTION1,OPTION2'\n" +
            ...
            'cli_reqd': "--detect.bazel.target='TARGET'\n" + \
    ...
    'BITBAKE':
        {
            ...
            'execs': ['bitbake'],
            'accuracy': 'HIGH',
            'cli_options':         "--detect.bitbake.package.names='PACKAGE1,PACKAGE2'\n" + \
            ...
            'cli_reqd': "--detect.bitbake.build.env.name=NAME\n" + \
    ...
    'CLANG':
        {
            ...
            'execs': ['clang'],
            'accuracy': 'HIGH',
            'cli_options':         "    Detect supports reading a compile_commands.json file generated by cmake.\n" + \
    ...
    'CONDA':
        {
            ...
            'execs': ['conda'],
            'accuracy': 'HIGH',
            'cli_options':         "--detect.conda.environment.name=NAME\n" + \
    ...
    'GRADLE':
        {
            ...
            'execs': ['go'],
            'accuracy': 'LOW',
            'cli_options': "--detect.gradle.build.command='ARGUMENT1 ARGUMENT2'\n" + \
    ...
    'MAVEN':
        {
            ...
            'execs': ['mvn', 'mvnw'],
            'accuracy': 'LOW',
            'cli_options':         "--detect.maven.build.command='ARGUMENT1 ARGUMENT2'\n" + \
    ...
    'NPM':
        {
            ...
            'execs': ['npm'],
            'accuracy': 'LOW',
            'cli_options': "--detect.npm.arguments='ARG1 ARG2'\n" + \
    ...
    'NUGET':
        {
            ...
            'execs': ['nuget'],
            'accuracy': 'LOW',
            'cli_options': "--detect.nuget.config.path=PATH\n" + \
    ...
    'PACKAGIST':
        {
            ...
            'execs': ['composer'],
            'accuracy': 'HIGH',
            'cli_options': "--detect.packagist.include.dev.dependencies=false\n" + \
    ...
    'PEAR':
        {
            ...
            'execs': ['pear'],
            'accuracy': 'HIGH',
            'cli_options': "--detect.pear.only.required.deps=true\n" + \
    ...
    'PIP':
        {
            ...
            'accuracy': 'HIGH',
            'cli_options': "--detect.pip.only.project.tree=true\n" + \
    ...
    'RUBYGEMS':
        {
            ...
            'execs': ['gem'],
            'accuracy': 'HIGH',
            'cli_options':  "--detect.ruby.include.dev.dependencies=true\n" + \
    ...
    'SBT':
        {
            ...
            'execs': ['sbt'],
            'accuracy': 'HIGH',
            'cli_options': "--detect.sbt.report.search.depth\n" + \
