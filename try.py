...
#					print("dir")
				...
				checkfile(zinfo.filename, fullpath, zinfo.file_size, depth)
...
# 								print( nested_zip.open('try.py').read())
						...
						print("ERROR: Can't open zip {} (Skipped)".format(fullpath))
						continue
...
print("- Large files (>1MB) = {} (Total size {}MB)".format(len(large_list), trunc(size_large/1000000)))
