...
def detector_process(folder, f):
    ...
    for cmd in detectors_list:
        if cmd in detector_cli_options_dict.keys() and 'dep' in cli_msgs_dict:
            cli_msgs_dict['dep'] += " For {}:\n".format(cmd) + detector_cli_options_dict[cmd]
        if cmd in detector_cli_required_dict.keys() and 'crit' in cli_msgs_dict:
...
def interactive(scanfolder, scantype, docker, critical_only, report, output_config):
    ...
    return (folder, scantype, docker_bool, critical_bool, report, config_bool)
...
if args.scanfolder == "" or args.interactive:
    ...
    args.scanfolder, scantype, args.docker, args.critical_only, args.report, args.output_config = \
        interactive(args.scanfolder, scantype, args.docker, args.critical_only, args.report, args.output_config)
    if scantype == "d":
